...
class ChimpMate_WPMC_Assistant_Admin {
	...
	public function wpmchimpa_update_setting()
	{
		...
		$ex = array('litebox_theme','addon_theme','widget_theme','lite_desktop','lite_tablet','lite_mobile','lite_homepage','lite_page','lite_post','lite_category','lite_search','lite_404error','lite_behave_time','lite_behave_time_inac','lite_behave_scroll','lite_behave_cookie','lite_close_time','lite_close_bck','addon_desktop','addon_tablet','addon_mobile','addon_page','addon_post','topbar_homepage','topbar_page','topbar_post','topbar_category','topbar_search','topbar_404error','flipbox_homepage','flipbox_page','flipbox_post','flipbox_category','flipbox_search','flipbox_404error','slider_theme','slider_desktop','slider_tablet','slider_mobile','slider_homepage','slider_page','slider_post','slider_category','slider_search','slider_404error','slider_orient','slider_close_bck','slider_behave_time','slider_behave_time_inac','slider_trigger_scroll','addon_orient','addon_scode');
