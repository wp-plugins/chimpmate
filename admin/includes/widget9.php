...
#wpmchimpaw h3{
padding-top:20px;
color: {{data.wtopt.widget_heading_fc||'#F4233C'}};
...
.widget_tbox.mailicon:before{
background: {{getIcon('m6',13,data.wtopt.widget_tbox_fc||'#000',345.779)}} no-repeat center;
}
.widget_tbox.pericon:before{
background: {{getIcon('m5',13,data.wtopt.widget_tbox_fc||'#000',612)}} no-repeat center;
}
...
background-color:{{data.wtopt.widget_button_bc||'#FF1F43'}};
width: {{data.wtopt.widget_button_w}}px;
height: {{data.wtopt.widget_button_h||'35'}}px;
line-height: {{data.wtopt.widget_button_h||'35'}}px;
...
border: {{data.wtopt.widget_button_bor||'1'}}px solid {{data.wtopt.widget_button_borc||'#FA0B38'}};
}
#wpmchimpaw .widget_button:hover{
color: {{data.wtopt.widget_button_fch}};
background-color: {{data.wtopt.widget_button_bch||'#FA0B38'}};
}
