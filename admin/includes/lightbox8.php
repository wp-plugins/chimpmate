...
width:350px;
background: {{data.ltopt.lite_bg_c || '#262E43'}};
...
margin-top:20px;
color: {{data.ltopt.lite_heading_fc||'#fff'}};
font-size: {{data.ltopt.lite_heading_fs||'20'}}px;
line-height: {{data.ltopt.lite_heading_fs||'20'}}px;
...
color: #ADBBE0;
font-size: {{data.ltopt.lite_msg_fs||'12'}}px;
...
background-color:{{data.ltopt.lite_button_bc||'#73C557'}};
width: {{data.ltopt.lite_button_w}}px;
height: {{data.ltopt.lite_button_h||'42'}}px;
line-height: {{data.ltopt.lite_button_h||'42'}}px;
-webkit-border-radius: {{data.ltopt.lite_button_br||'3'}}px;
-moz-border-radius: {{data.ltopt.lite_button_br||'3'}}px;
border-radius: {{data.ltopt.lite_button_br||'3'}}px;
border: {{data.ltopt.lite_button_bor||'1'}}px solid {{data.ltopt.lite_button_borc||'#50B059'}};
}
#wpmchimpa .lite_button:hover{
color: {{data.ltopt.lite_button_fch}};
background-color: {{data.ltopt.lite_button_bch||'#50B059'}};
}
...
color: {{data.ltopt.lite_soc_fc||'#ADACB2'}};
font-size: {{data.ltopt.lite_soc_fs||'13'}}px;
line-height: {{data.ltopt.lite_soc_fs||'13'}}px;
...
border-radius: 2px;
cursor: pointer;
border:1px solid {{data.ltopt.lite_bg_c || '#262E43'}};
}
...
#wpmchimpa .wpmchimpa-tag *{
pointer-events: none;
color: {{data.ltopt.lite_tag_fc||'#68728D'}};
...
content:{{getIcon('lock1',data.ltopt.lite_tag_fs||10,data.ltopt.lite_tag_fc||'#68728D')}};
margin: 5px;
top: 1px;
position: relative;
}
...
<div class="wpmchimpa-overlay-bg wpmchimpa-wrapper" id="lightbox1">
	<div id="wpmchimpa-main" ng-class="{'wosoc':data.ltopt.lite_dissoc}">
