...
background:  {{data.stopt.slider_bg_c||'#27313B'}} no-repeat;
...
padding-top:20px;
margin: 0;
color: {{data.stopt.slider_heading_fc||'#F4233C'}};
font-size: {{data.stopt.slider_heading_fs||'24'}}px;
line-height: {{data.stopt.slider_heading_fs||'24'}}px;
...
color: #959595;
font-size: {{data.stopt.slider_msg_fs||'15'}}px;
...
.slider_tbox.mailicon:before{
background: {{getIcon('m6',15,data.stopt.slider_tbox_fc||'#000',345.779)}} no-repeat center;
}
.slider_tbox.pericon:before{
background: {{getIcon('m5',15,data.stopt.slider_tbox_fc||'#000',612)}} no-repeat center;
}
...
background-color:{{data.stopt.slider_button_bc||'#FF1F43'}};
width: {{data.stopt.slider_button_w}}px;
height: {{data.stopt.slider_button_h||'40'}}px;
line-height: {{data.stopt.slider_button_h||'40'}}px;
border-radius: {{data.stopt.slider_button_br}}px;
border: {{data.stopt.slider_button_bor||'1'}}px solid {{data.stopt.slider_button_borc||'#FA0B38'}};
}
#wpmchimpas .slider_button:hover{
color: {{data.stopt.slider_button_fch}};
background-color: {{data.stopt.slider_button_bch||'#FA0B38'}};
}
...
#slider_tag:before{
content:{{getIcon('lock1',data.stopt.slider_tag_fs||10,data.stopt.slider_tag_fc||'#fff')}};
margin: 5px;
top: 1px;
position: relative;
}
...
background: {{data.stopt.slider_trigger_bg || '#27313B'}};
}
#wpmchimpas-trig:before{ 
content:{{getIcon('m4',32,data.stopt.slider_trigger_c||'#fff',334.5)}};
height: 32px;
width: 32px;
display: block;
margin: 8px;
