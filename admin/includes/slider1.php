...
height: 718px;
display: block;
background: {{data.stopt.slider_canvas_c||'#333'}};
position: relative;
}
...
margin: 25px;
text-align: center;
background:  {{data.stopt.slider_bg_c||'#fff'}};
...
width: 100%;
text-align: center;
display: {{data.stopt.slider_dissoc?'none':'inline-block'}};
}
#wpmchimpas h3{
color: {{data.stopt.slider_heading_fc}};
font-size: {{data.stopt.slider_heading_fs||'18'}}px;
...
font-size: {{data.stopt.slider_msg_fs}}px;
...
font-size: {{data.stopt.slider_tbox_fs||'16'}}px;
font-weight: {{data.stopt.slider_tbox_fw||'bold'}};
font-family: {{data.stopt.slider_tbox_f | livepf}};
font-style: {{data.stopt.slider_tbox_fst}};
background-color: {{data.stopt.slider_tbox_bgc||'#f8fafa'}};
width: {{data.stopt.slider_tbox_w}}px;
height: {{data.stopt.slider_tbox_h||'45'}}px;
border: {{data.stopt.slider_tbox_bor||'1'}}px solid {{data.stopt.slider_tbox_borc||'#e4e9e9'}};
}
...
text-align: center;
position: absolute;
-webkit-box-shadow: 0 0 1px 1px {{data.stopt.slider_check_borc||'#ccc'}};
-moz-box-shadow: 0 0 1px 1px {{data.stopt.slider_check_borc||'#ccc'}};
-ms-box-shadow: 0 0 1px 1px {{data.stopt.slider_check_borc||'#ccc'}};
-o-box-shadow: 0 0 1px 1px {{data.stopt.slider_check_borc||'#ccc'}};
...
font-size: {{data.stopt.slider_button_fs || "22"}}px;
font-weight: {{data.stopt.slider_button_fw||'bold'}};
font-family: {{data.stopt.slider_button_f | livepf}};
font-style: {{data.stopt.slider_button_fst}};
{{data.stopt.slider_button_bc? "background-color:"+data.stopt.slider_button_bc+";" : "background-color: #4d90fe;
...
height: {{data.stopt.slider_button_h||'45'}}px;
border: {{data.stopt.slider_button_bor||'1'}}px solid {{data.stopt.slider_button_borc||'#3079ed'}};
}
...
margin-top: 15px;
position: relative;
border: 2px solid {{data.stopt.slider_spinner_c||'#000'}};
...
line-height: 30px;
display: block;
color: {{data.stopt.slider_soc_fc||'#b3b3b3'}};
font-size: {{data.stopt.slider_soc_fs||'20'}}px;
