...
left: 624px;
top: 95px;
background: {{data.wtopt.widget_bg_c||'#fff'}};
position: relative;
}
#wpmchimpaw .wpmchimpa-leftpane{
width: 100%;
text-align: center;
display: {{data.wtopt.widget_dissoc?'none':'inline-block'}};
}
#wpmchimpaw .widget_msg, #wpmchimpaw .widget_msg *{
font-size: {{data.wtopt.widget_msg_fs}}px;
...
font-size: {{data.wtopt.widget_tbox_fs||'16'}}px;
font-weight: {{data.wtopt.widget_tbox_fw||'bold'}};
font-family: {{data.wtopt.widget_tbox_f | livepf}};
font-style: {{data.wtopt.widget_tbox_fst}};
background-color: {{data.wtopt.widget_tbox_bgc||'#f8fafa'}};
width: {{data.wtopt.widget_tbox_w}}px;
height: {{data.wtopt.widget_tbox_h||'45'}}px;
border: {{data.wtopt.widget_tbox_bor||'1'}}px solid {{data.wtopt.widget_tbox_borc||'#e4e9e9'}};
}
...
text-align: center;
position: absolute;
-webkit-box-shadow: 0 0 1px 1px {{data.wtopt.widget_check_borc||'#ccc'}};
-moz-box-shadow: 0 0 1px 1px {{data.wtopt.widget_check_borc||'#ccc'}};
-ms-box-shadow: 0 0 1px 1px {{data.wtopt.widget_check_borc||'#ccc'}};
-o-box-shadow: 0 0 1px 1px {{data.wtopt.widget_check_borc||'#ccc'}};
...
font-size: {{data.wtopt.widget_button_fs || "22"}}px;
font-weight: {{data.wtopt.widget_button_fw||'bold'}};
font-family: {{data.wtopt.widget_button_f | livepf}};
font-style: {{data.wtopt.widget_button_fst}};
{{data.wtopt.widget_button_bc? "background-color:"+data.wtopt.widget_button_bc+";" : "background-color: #4d90fe;
...
height: {{data.wtopt.widget_button_h||'45'}}px;
border: {{data.wtopt.widget_button_bor||'1'}}px solid {{data.wtopt.widget_button_borc||'#3079ed'}};
}
...
left: calc(50% - 20px);
position: relative;
border: 2px solid {{data.wtopt.widget_spinner_c||'#000'}};
...
line-height: 30px;
display: block;
color: {{data.wtopt.widget_soc_fc||'#b3b3b3'}};
font-size: {{data.wtopt.widget_soc_fs||'20'}}px;
...
<div id="wpmchimpaw">
  <div class="wpmc-live-sc" ng-click="gotos($event)" data-optno="7" data-lhint="Go to Additional Theme Options" style="margin:-15px">6</div>
        ...
        <div class="wpmchimpa" id="wpmchimpa">
            ...
            <div>
              <div class="widget_spinner"><div class="wpmc-live-sc" ng-click="gotos($event)" data-optno="5" data-lhint="Go to Spinner Settings" style="margin:25%">5</div></div>
            </div>
