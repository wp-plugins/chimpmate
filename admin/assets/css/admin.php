...
input.wpmchimp-color-sel:focus{
-webkit-box-shadow:none;
box-shadow:none;
}
.ms-parent {
...
.ms-choice > div {
    ...
    width: 20px;
    height: 25px;
    background: url('<?php echo plugin_dir_url( __FILE__ ).'multi-select.png';?>') left -2px no-repeat;
}

.ms-choice > div.open {
    background: url('<?php echo plugin_dir_url( __FILE__ ).'multi-select.png';?>') left -22px no-repeat;
}
...
.ms-search input {
    ...
    -o-box-shadow: none;
    box-shadow: none;
    background: #fff url('<?php echo plugin_dir_url( __FILE__ ).'multi-select.png';?>') no-repeat 100% bottom;
    background: url('<?php echo plugin_dir_url( __FILE__ ).'multi-select.png';?>') no-repeat 100% bottom, -webkit-gradient(linear, left bottom, left top, color-stop(0.85, white), color-stop(0.99, #eeeeee));
    background: url('<?php echo plugin_dir_url( __FILE__ ).'multi-select.png';?>') no-repeat 100% bottom, -webkit-linear-gradient(center bottom, white 85%, #eeeeee 99%);
    background: url('<?php echo plugin_dir_url( __FILE__ ).'multi-select.png';?>') no-repeat 100% bottom, -moz-linear-gradient(center bottom, white 85%, #eeeeee 99%);
    background: url('<?php echo plugin_dir_url( __FILE__ ).'multi-select.png';?>') no-repeat 100% bottom, -o-linear-gradient(bottom, white 85%, #eeeeee 99%);
    background: url('<?php echo plugin_dir_url( __FILE__ ).'multi-select.png';?>') no-repeat 100% bottom, -ms-linear-gradient(top, #ffffff 85%, #eeeeee 99%);
    background: url('<?php echo plugin_dir_url( __FILE__ ).'multi-select.png';?>') no-repeat 100% bottom, linear-gradient(top, #ffffff 85%, #eeeeee 99%);
}
...
display: block;
padding: 7px 0px;
background-image: url('<?php echo plugins_url('/chimpmate/admin/includes/ChimpMate.png');?>');
...
.wpmca_home .wpmca_header .wpmca_logo {
	display: inline-block;
	border-radius: 50%;
  background-image: url('<?php echo plugins_url('/chimpmate/admin/includes/freddie.png');?>');
...
.wpmca_home .wpmca_group .wpmca_compac { 
float: left;
margin: 10px 20px;
}
.p1{
...
.orientvdemo.mido:before{
top:15px
}
.orientvdemo.boto:before{
top:30px
}
...
.wpmca_group.wpmcacolor{top:10px}
...
.wpmcarange .rangeslider,
.wpmcarange .rangeslider__fill {
  background: #e6e6e6;
  display: block;
  height: 2px;
  width: 260px;
...
.wpmcarange .rangeslider__handle {
  background: white;
  cursor: pointer;
  display: inline-block;
  width: 16px;
...
.wpmcarange .rangeslider__handle:before,
.wpmcarange .rangeslider__handle:after{
...
.wpmcarange .rangeslider__handle:active:before{
...
.wpmcarange .rangeslider__handle:active:after{
...
select.wpmca_sel,select.wpmca_sel:focus{
  ...
  -moz-box-shadow:none;
  -webkit-box-shadow:none;
  background: url('<?php echo plugin_dir_url( __FILE__ ).'multi-select.png';?>') no-repeat 100% top;
  appearance:none;
-moz-appearance:none;
-webkit-appearance:none;
text-indent: 0.01px;
...
.wpmca_topbar .wpmca_round{
  width: 20px;
  height: 20px;
  border-radius: 50%;
  margin-top: 5px;
}
.wpmca_topbar .wpmca_long{
  width:585px;
  margin-right: 5px;
}
.wpmca_topbar .wpmca_long::before{
content: "ChimpMate - Live Editor";
color: #AFAFAF;
padding: 6px 15px;
display: block;
font-family: Arial;
...
.wpmca_topbar .wpmca_search{
  width: 199px;
  margin: 0;
}
.wpmca_topbar div:after{
line-height: 32px;
font-family: dashicons;
color:#ccc;
font-size: 30px;
...
.wpmca_topbar .wpmca_opts{
background: none;
margin-left: 4px;
}
.wpmca_topbar .wpmca_opts:after{
content:"\f333";
font-size: 40px;
color: #e6e6e6;
}
.wpmca_topbar .wpmca_left:after{
content:"\f341";
left: 1px;
}
.wpmca_topbar .wpmca_right:after{
content:"\f345";
left: 2px;
}
.wpmca_topbar .wpmca_search:after{
content:"\f179";
font-size:23px;
}
.wpmca_viewportbck{
...
content:'';
  ...
  width:20px;
  margin: -2px -2px;
  -webkit-animation: live-sc-indicate 1s ease-out infinite;
  -moz-animation: live-sc-indicate 1s ease-out infinite;
  -ms-animation: live-sc-indicate 1s ease-out infinite;
  -o-animation: live-sc-indicate 1s ease-out infinite;
  animation: live-sc-indicate 1s ease-out infinite;
}
.wpmc-live-sc:hover:after {
...
.wpmc-live-sc.righthov:hover:after{
right:20%;
left:inherit;
}
@-webkit-keyframes live-sc-indicate {
    0% {
      -webkit-transform:scale(.1);
      opacity: 0.0;
    }
...
@-moz-keyframes live-sc-indicate {
    0% {
      -moz-transform:scale(.1);
      opacity: 0.0;
    }
